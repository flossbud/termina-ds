...
extern "C" void JNICALL Java_com_terminads_mm_MainActivity_attachController(JNIEnv* env, jobject obj) {
...
extern "C" void JNICALL Java_com_terminads_mm_MainActivity_setCameraState(JNIEnv *env, jobject jobj, jint axis, jfloat value) {
    switch(axis){
        case 0:
            cameraYaw=value;
            break;
...
extern "C" void JNICALL Java_com_terminads_mm_MainActivity_setButton(JNIEnv *env, jobject jobj, jint button, jboolean value) {
    if(button < 0){
...
extern "C" void JNICALL Java_com_terminads_mm_MainActivity_setAxis(JNIEnv *env, jobject jobj, jint axis, jshort value) {
    SDL_JoystickSetVirtualAxis(virtual_joystick, axis, value);
}

extern "C" void JNICALL Java_com_terminads_mm_MainActivity_detachController(JNIEnv *env, jobject jobj) {
